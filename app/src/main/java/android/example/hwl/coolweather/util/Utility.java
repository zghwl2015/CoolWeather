...
public class Utility {
     ...
     * 解析和处理服务器返回的市级数据
     */
    public static boolean handleProvinceResponse(String response, int provinceId){
        if (!TextUtils.isEmpty(response)){
            try {
     ...
     * 解析和处理服务器返回的省级数据
     */
    public static boolean handleProvinceResponse(String response, int cityId){
        if (!TextUtils.isEmpty(response)){
            try {
